...
const IMAGES = {
    ...
    health: "https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?auto=format&fit=crop&q=80&w=2070",
    assessment: "https://images.unsplash.com/photo-1526628953301-3e589a6a8b74?auto=format&fit=crop&q=80&w=2006",
    coverage: "https://images.unsplash.com/photo-1451187580459-43490279c0fa?auto=format&fit=crop&q=80&w=2072"
};
                    ...
                    <Slide key="hero" isActive={currentSlide === 0}>
                        <div className="flex flex-col items-center justify-center text-center gap-8 h-full">
                            ...
                            <motion.button
                                ...
                                whileTap={{ scale: 0.95 }}
                                className="mt-8 px-8 py-4 bg-brand-cyan text-[#020617] font-extrabold rounded-full text-lg shadow-[0_0_20px_rgba(6,182,212,0.3)] hover:shadow-[0_0_40px_rgba(6,182,212,0.5)] transition-shadow relative z-20"
                            >
                                <span className="relative z-30">Start the Journey</span>
                            </motion.button>
                        </div>
                    </Slide>
                )}
                    ...
                    <Slide key="coverage" isActive={currentSlide === 5}>
                        ...
                        >
                            ...
                            <div className="mt-12 flex gap-4">
                                ...
                                <button className="px-8 py-3 bg-brand-cyan text-[#020617] font-extrabold rounded-full hover:bg-brand-cyan/90 transition-colors relative z-20">
                                    <span className="relative z-30">Contact Sales</span>
                                </button>
                            </div>
                        </SlideContent>
                    </Slide>
