    ...
    if (layout === 'center') {
        return (
            <div className="flex flex-col items-center text-center gap-8">
                ...
                {image && (
                    <div className="w-full max-w-5xl aspect-video rounded-2xl overflow-hidden shadow-2xl shadow-cyan-500/10 border border-slate-800 bg-slate-900/50 backdrop-blur-sm">
    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
            ...
            <div className="order-1 lg:order-2">
                {image ? (
                    <div className="w-full aspect-[4/3] rounded-2xl overflow-hidden shadow-2xl shadow-slate-900/50 border border-slate-700/50 bg-slate-800/20 backdrop-blur">
