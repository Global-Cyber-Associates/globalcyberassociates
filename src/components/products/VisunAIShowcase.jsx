  ...
  return (
    <div className="va-page va">
      ...
      <Helmet>
        ...
        <meta name="description" content="VisuN AI is real-time employee and network monitoring software: live device visibility, user activity monitoring, USB &amp; file activity logging, insider threat detection, and vulnerability scanning. Starts from $7 per endpoint/month." />
        ...
        <meta property="og:description" content="See every device, every employee, every file — live. Insider threat detection, USB &amp; file logging, and vulnerability scanning starts from $7 per endpoint/month." />
        ...
        <meta name="twitter:description" content="Real-time employee and network monitoring with insider threat detection. Starts from $7 per endpoint/month." />
