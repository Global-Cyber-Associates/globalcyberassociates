...
function PriceTag() {
  ...
  useEffect(() => {
    ...
    gsap.to(obj, {
      ...
      onComplete: () => { el.textContent = '7$'; },
    });
  }, []);
  return <span ref={numRef} className="pg-price-num">7$</span>;
}
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Explore GCA's AI-powered cybersecurity products. VisuN AI delivers real-time network visibility, employee monitoring, USB &amp; file activity logging, and vulnerability scanning — from $7 per endpoint/month." />
        ...
        <meta property="og:description" content="VisuN AI: real-time endpoint monitoring, network topology, vulnerability scanning, and workforce analytics in one platform. From $7 per endpoint/month." />
        ...
        <meta name="twitter:description" content="VisuN AI: real-time endpoint monitoring, network topology, vulnerability scanning, and workforce analytics. From $7 per endpoint/month." />
